...
# Utility functions\Method used in the program


#this function helps identify if the transaction is ORDER
def is_a_order(type):
   if type=="ORDER":
       return 1
   else:
...
#this function helps identify if the transaction is RETURN
...
#this function helps calculate the count of items in the transaction
...
#this function helps calculate the total cost of a invoice
...
# Time based KPIs - Calculation - Watermarking allows lateness by 1 minute
...
# Time and Country based KPIs - Calculation - Watermarking allows lateness by 1 minute
...
#run continuous unless termination is called
